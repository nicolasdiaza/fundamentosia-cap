"""
===============================================================================
MÓDULO DE REGRESIÓN - PASO 4: SIMULADOR VISUAL DE PLANIFICACIÓN MIGRATORIA
Capacitación de IA - Servicio Nacional de Migración de Panamá (Día 5)
===============================================================================
OBJETIVO:
Simulador intuitivo tipo velocímetro/medidor de capacidad para que cualquier usuario 
sin formación técnica entienda instantáneamente el resultado de la predicción de IA.
===============================================================================
"""
...
COEF_INSPECTORES, COEF_PRESUPUESTO, COEF_ESPERA = modelo_regresion.coef_
...
# 3. Definir áreas de la interfaz
...
fig.text(0.08, 0.665, f'Lo que la IA aprendió: +1 inspector = {COEF_INSPECTORES:+.0f} trámites', fontsize=8.5, color='#00529B', style='italic')
...
fig.text(0.08, 0.465, f'Lo que la IA aprendió: +$1 USD = {COEF_PRESUPUESTO:+.2f} trámites', fontsize=8.5, color='#2E7D32', style='italic')
...
fig.text(0.08, 0.265, f'Lo que la IA aprendió: +1 minuto = {COEF_ESPERA:+.0f} trámites', fontsize=8.5, color='#D9381E', style='italic')

# Botón Reset
ax_boton = fig.add_axes([0.15, 0.14, 0.18, 0.05])
boton_reset = Button(ax_boton, 'Restablecer Valores', color='#ffffff', hovercolor='#e2e8f0')

# 5. Función de actualización del Medidor de Capacidad
