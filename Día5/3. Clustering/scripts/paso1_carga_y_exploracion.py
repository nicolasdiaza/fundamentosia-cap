# Paso 1: carga y exploración de datos (EDA) sin etiquetas (aprendizaje no supervisado)
...
# Paso 2: cargar dataset de historia
...
# Paso 3: ficha técnica + diagrama de dispersión sin agrupar
...
plt.figtext(0.5, 0.02,
            ...
            "• Todos los puntos se ven grises e iguales. El objetivo de la IA será encontrar los patrones y grupos ocultos.\n"
