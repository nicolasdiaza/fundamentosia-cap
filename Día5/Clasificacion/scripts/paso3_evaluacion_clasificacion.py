"""
===============================================================================
MÓDULO DE CLASIFICACIÓN - PASO 3: EVALUACIÓN (MATRIZ DE CONFUSIÓN Y MÉTRICAS)
Capacitación de IA - Servicio Nacional de Migración de Panamá (Día 5)
===============================================================================
OBJETIVO:
Evaluar el modelo de Clasificación en el dataset independiente 'dataset_evaluacion_clasificacion.csv'
mostrando de forma visual e intuitiva la Matriz de Confusión 2x2 y las 4 métricas clave:
...
# 2. Cargar modelo y dataset de prueba independiente
...
# 5. Gráfica 1: Matriz de Confusión Explicada de Forma Visual
...
# 6. Gráfica 2: Las 4 Métricas Clave en Barras Porcentuales
