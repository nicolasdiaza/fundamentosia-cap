"""
===============================================================================
MÓDULO DE REGRESIÓN - PASO 3: EVALUACIÓN EN DATASET INDEPENDIENTE DE TEST (OUT-OF-SAMPLE)
Capacitación de IA - Servicio Nacional de Migración de Panamá (Día 5)
===============================================================================
OBJETIVO:
Evaluar el desempeño final del modelo cargando el tercer dataset independiente:
'dataset_evaluacion_final.csv' (Datos que NUNCA intervinieron ni en el entrenamiento
ni en el train_test_split del paso 2).
===============================================================================
"""
...
# 2. Cargar modelo y dataset independiente de evaluación
...
# 3. Predecir sobre los datos de evaluación final
...
# 5. Gráfica de comparación Real vs Predicho
