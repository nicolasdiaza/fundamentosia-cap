"""
===============================================================================
MÓDULO DE CLASIFICACIÓN - PASO 4: SIMULADOR VISUAL DE ALERTAS DE CONGESTIÓN
Capacitación de IA - Servicio Nacional de Migración de Panamá (Día 5)
===============================================================================
OBJETIVO:
Simulador interactivo con interfaz gráfica (Sliders + Panel Semafórico en tiempo real)
para probar las decisiones del modelo de Clasificación en un puesto migratorio.
===============================================================================
"""
...
# 1. Cargar modelo y datos históricos
...
# Botón Reset
ax_boton = fig.add_axes([0.08, 0.12, 0.145, 0.05])
...
fig.text(0.08, 0.19, 'Escenarios Rápidos:', fontsize=9.5, fontweight='bold', color='#333333')

ax_esc1 = fig.add_axes([0.245, 0.12, 0.145, 0.05])
boton_tranquilo = Button(ax_esc1, 'Turno Tranquilo', color='#e8f5e9', hovercolor='#c8e6c9')

ax_esc2 = fig.add_axes([0.41, 0.12, 0.145, 0.05])
boton_critico = Button(ax_esc2, 'Turno Crítico', color='#ffebee', hovercolor='#ffcdd2')

# 5. Función de actualización del Semáforo y Predicción
def actualizar(val=None):
    ...
    pred_clase = modelo_clasificacion.predict(df_input)[0]
